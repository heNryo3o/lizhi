...
<head>
    ...
    <title>励志语录365网{{ isset($title) && $title ? '|'.$title : '' }}</title>
    <meta name="keywords" content="{{ isset($keywords) && $keywords ? '励志语录,'.$keywords : '励志名言,名人名言,励志电影,励志歌曲,经典语录,经典语句' }}" />
    <meta name="description" content="{{ isset($desc) && $desc ? $desc : '励志语录365网致力于分享励志名言,名人名言,励志电影,励志歌曲,经典语录,经典语句相关内容，励志，从这里开始！'}}" />
